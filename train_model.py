...
def net(train_data, valid_data, loss_criterion, optimizer, args, hook):
    ...
    model.fit(train_data, epochs=args.epochs, callbacks=[early_stop, checkpoint, hook])
    
    hook.set_mode(mode=smd.modes.EVAL)
    model.evaluate(valid_data, callbacks=[hook])
...
def main(args):
    ...
    image_classifier = net(train_data, valid_data, loss_criterion, optimizer, args, hook)
